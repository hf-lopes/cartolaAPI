...
class FeatureQueries:
    ...
    def team_goals_scored_home(self, scout_id, n_rounds):
        ...
        return df[feature_name].rename(feature_name, inplace=True)
    ...
    def team_points_enemy_points_ratio(self, scout_id, n_rounds):
        ...
        return df_team[feature_name].rename(feature_name, inplace=True)
    ...
    def player_goal_participation(self, scout_id, n_rounds):
        ...
        df_goals = self.average_plays(scout_id=scout_id, n_rounds=n_rounds, play_type=abreviacao.index('G') + 1) * points_dict['G']
        df_assists = self.average_plays(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('A') + 1) * points_dict['A']
        df_ft = self.average_plays(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('FT') + 1) * points_dict['FT']
        df_ff = self.average_plays(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('FF') + 1) * points_dict['FF']
        df_fd = self.average_plays(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('FD') + 1) * points_dict['FD']
    ...
    def clean_sheet_chance(self, scout_id, n_rounds):
        ...
        df_sg = self.average_plays(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('SG') + 1) * points_dict['SG']
    ...
    def player_goal_participation_team_ratio(self, scout_id, n_rounds):
        ...
        df_goals_team = self.average_plays_team(scout_id=scout_id, n_rounds=n_rounds, play_type=abreviacao.index('G') + 1) * points_dict['G']
        df_assists_team = self.average_plays_team(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('A') + 1) * points_dict['A']
        df_ft_team = self.average_plays_team(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('FT') + 1) * points_dict['FT']
        df_ff_team = self.average_plays_team(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('FF') + 1) * points_dict['FF']
        df_fd_team = self.average_plays_team(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('FD') + 1) * points_dict['FD']
        ...
        return df_points[feature_name].rename(feature_name, inplace=True)
    ...
    def team_offense_enemy_defense(self, scout_id, n_rounds):
        ...
        df_ff_team = self.average_plays_team(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('FF') + 1) * points_dict['FF']
        df_fd_team = self.average_plays_team(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('FD') + 1) * points_dict['FD']
        df_i_team = self.average_plays_team(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('I') + 1) * points_dict['I']
        df_pp_team = self.average_plays_team(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('PP') + 1) * points_dict['PP']

        df_rb_enemy = self.average_plays_enemy_team(scout_id=scout_id, n_rounds=n_rounds, play_type=abreviacao.index('RB') + 1) * points_dict['RB']
        df_sg_enemy = self.average_plays_enemy_team(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('SG') + 1) * points_dict['SG']
        df_dd_enemy = self.average_plays_enemy_team(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('DD') + 1) * points_dict['DD']
        df_dp_enemy = self.average_plays_enemy_team(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('DP') + 1) * points_dict['DP']
        ...
        return df_points_team[feature_name].rename(feature_name, inplace=True)

    def team_defense_enemy_offense(self, scout_id, n_rounds):
        feature_name = "team_defense_enemy_offense_last_" + str(n_rounds) + '_rounds'

        df_goals_enemy = self.average_plays_enemy_team(scout_id=scout_id, n_rounds=n_rounds, play_type=abreviacao.index('G') + 1) * points_dict['G']
        df_assists_enemy = self.average_plays_enemy_team(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('A') + 1) * points_dict['A']
        df_ft_enemy = self.average_plays_enemy_team(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('FT') + 1) * points_dict['FT']
        df_ff_enemy = self.average_plays_enemy_team(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('FF') + 1) * points_dict['FF']
        df_fd_enemy = self.average_plays_enemy_team(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('FD') + 1) * points_dict['FD']
        df_i_enemy = self.average_plays_enemy_team(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('I') + 1) * points_dict['I']
        df_pp_enemy = self.average_plays_enemy_team(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('PP') + 1) * points_dict['PP']

        df_rb_team = self.average_plays_team(scout_id=scout_id, n_rounds=n_rounds, play_type=abreviacao.index('RB') + 1) * points_dict['RB']
        df_sg_team = self.average_plays_team(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('SG') + 1) * points_dict['SG']
        df_dd_team = self.average_plays_team(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('DD') + 1) * points_dict['DD']
        df_dp_team = self.average_plays_team(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('DP') + 1) * points_dict['DP']
        print("Calculating Feature: %s" % feature_name)
    ...
    def team_rb_enemy_pe(self, scout_id, n_rounds):
        ...
        df_pe_enemy = self.average_plays_enemy_team(scout_id=scout_id, n_rounds=n_rounds, play_type=abreviacao.index('PE') + 1) * points_dict['PE']

        df_rb_team = self.average_plays_team(scout_id=scout_id, n_rounds=n_rounds, play_type=abreviacao.index('RB') + 1) * points_dict['RB']

        df_rb_player = self.average_plays(scout_id=scout_id, n_rounds=n_rounds, play_type=abreviacao.index('RB') + 1) * points_dict['RB']
        print("Calculating Feature: %s" % feature_name)

        df_rb_team[feature_name] = (df_rb_team * df_rb_player * df_pe_enemy)
        return df_rb_team[feature_name].rename(feature_name, inplace=True)

    def player_pe_enemy_rb(self, scout_id, n_rounds):
        feature_name = "player_pe_enemy_rb_last_" + str(n_rounds) + '_rounds'

        df_rb_enemy = self.average_plays_enemy_team(scout_id=scout_id, n_rounds=n_rounds, play_type=abreviacao.index('RB') + 1) * points_dict['RB']

        df_pe_player = self.average_plays(scout_id=scout_id, n_rounds=n_rounds, play_type=abreviacao.index('PE') + 1) * points_dict['PE']
        print("Calculating Feature: %s" % feature_name)

        df_pe_player[feature_name] = (df_pe_player * df_rb_enemy)
        return df_pe_player[feature_name].rename(feature_name, inplace=True)

    def player_fs_enemy_fc(self, scout_id, n_rounds):
        feature_name = "player_fs_enemy_fc_last_" + str(n_rounds) + '_rounds'

        df_fc_enemy = self.average_plays_enemy_team(scout_id=scout_id, n_rounds=n_rounds, play_type=abreviacao.index('FC') + 1) * points_dict['FC']

        df_fs_player = self.average_plays(scout_id=scout_id, n_rounds=n_rounds, play_type=abreviacao.index('FS') + 1) * points_dict['FS']
        print("Calculating Feature: %s" % feature_name)

        df_fs_player[feature_name] = (df_fs_player * df_fc_enemy)
        return df_fs_player[feature_name].rename(feature_name, inplace=True)

    def enemy_fs_player_fc_ca_cv(self, scout_id, n_rounds):
        feature_name = "enemy_fs_player_fc_ca_cv_last_" + str(n_rounds) + '_rounds'

        df_fs_enemy = self.average_plays_enemy_team(scout_id=scout_id, n_rounds=n_rounds, play_type=abreviacao.index('FS') + 1) * points_dict['FS']

        df_fc_player = self.average_plays(scout_id=scout_id, n_rounds=n_rounds, play_type=abreviacao.index('FC') + 1) * points_dict['FC']
        df_ca_player = self.average_plays(scout_id=scout_id, n_rounds=n_rounds, play_type=abreviacao.index('CA') + 1) * points_dict['CA']
        df_cv_player = self.average_plays(scout_id=scout_id, n_rounds=n_rounds, play_type=abreviacao.index('CV') + 1) * points_dict['CV']
        print("Calculating Feature: %s" % feature_name)

        df_bad = df_fc_player + df_ca_player + df_cv_player
        df_bad[feature_name] = (df_bad * df_fs_enemy)
        return df_bad[feature_name].rename(feature_name, inplace=True)
    ...
    def team_offense_enemy_fauls(self, scout_id, n_rounds):
        ...
        df_fc_player = self.average_plays_enemy_team(scout_id=scout_id, n_rounds=n_rounds, play_type=abreviacao.index('FC') + 1) * points_dict['FC']
        df_ca_player = self.average_plays_enemy_team(scout_id=scout_id, n_rounds=n_rounds, play_type=abreviacao.index('CA') + 1) * points_dict['CA']
        df_cv_player = self.average_plays_enemy_team(scout_id=scout_id, n_rounds=n_rounds, play_type=abreviacao.index('CV') + 1) * points_dict['CV']
        print("Calculating Feature: %s" % feature_name)
    ...
    def team_fauls_enemy_offense(self, scout_id, n_rounds):
        ...
        df_fc_team = self.average_plays_team(scout_id=scout_id, n_rounds=n_rounds, play_type=abreviacao.index('FC') + 1) * points_dict['FC']
        df_ca_team = self.average_plays_team(scout_id=scout_id, n_rounds=n_rounds, play_type=abreviacao.index('CA') + 1) * points_dict['CA']
        df_cv_team = self.average_plays_team(scout_id=scout_id, n_rounds=n_rounds, play_type=abreviacao.index('CV') + 1) * points_dict['CV']
        print("Calculating Feature: %s" % feature_name)
        ...
        return df_points_enemy[feature_name].rename(feature_name, inplace=True)


    def team_goal_chance(self, scout_id, n_rounds):
        feature_name = "team_goal_chance_last_" + str(n_rounds) + '_rounds'
        df_goals = self.average_plays_team(scout_id=scout_id, n_rounds=n_rounds, play_type=abreviacao.index('G') + 1) * points_dict['G']
        df_assists = self.average_plays_team(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('A') + 1) * points_dict['A']
        df_ft = self.average_plays_team(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('FT') + 1) * points_dict['FT']
        df_ff = self.average_plays_team(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('FF') + 1) * points_dict['FF']
        df_fd = self.average_plays_team(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('FD') + 1) * points_dict['FD']
        print("Calculating Feature: %s" % feature_name)
    ...
    def enemy_goal_chance(self, scout_id, n_rounds):
        ...
        df_goals = self.average_plays_enemy_team(scout_id=scout_id, n_rounds=n_rounds, play_type=abreviacao.index('G') + 1) * points_dict['G']
        df_assists = self.average_plays_enemy_team(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('A') + 1) * points_dict['A']
        df_ft = self.average_plays_enemy_team(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('FT') + 1) * points_dict['FT']
        df_ff = self.average_plays_enemy_team(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('FF') + 1) * points_dict['FF']
        df_fd = self.average_plays_enemy_team(scout_id=scout_id, n_rounds=n_rounds, play_type = abreviacao.index('FD') + 1) * points_dict['FD']
        print("Calculating Feature: %s" % feature_name)
